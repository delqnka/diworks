...
export const siteContent = {
  en: {
    ...
    storyParagraphs: [
      ...
      "That's why I started Alter Nine.",
    ...
    independenceEyebrow: "WHY WORK WITH ME",
    independenceTitle: "Your website stays under your control.",
    independenceBody: [
      "The biggest advantage of the websites I build is that you won't have to pay for every tiny correction.",
      "I've always valued independence in my own business, and that's exactly what I want to give my clients too.",
      "I built a control panel where you can edit prices, headings, text, services, and upload or remove photos yourself, without relying on a developer for every small change.",
      "I also integrated AI that can read your pricelist in seconds and automatically add your services to the website, so you don't have to enter them manually.",
      "Every customer booking is stored in your own client database, where you can see visits, booking history and spend over time."
    ],
    ...
    buildItems: [
      ...
      ["03", "Custom-built platforms", "Bespoke web applications tailored to your business. The flagship is my own booking software engine - the same one powering every appointment-based Alter Nine website."],
  ...
  bg: {
    ...
    heroTitleStart: "Професионален сайт с",
    heroTitleAccent: "реално онлайн",
    heroTitleEnd: "записване",
    heroLead:
      "Не просто форма за запитване. Услуги, цени, галерия, депозити и реално онлайн записване с календар на едно място. Готов за 3-5 работни дни.",
    heroSecondary: "Виж реален сайт",
    heroTrust: "Без външни страници за резервации. Създаден първо за мобилни устройства. Ръчно изработен, не по шаблон.",
    heroDemoHint: "Кликни което и да е „Нека поговорим“ - точно така клиентите ти ще резервират.",
    ...
    compareBadText:
      "Когато клиентът напусне сайта ти, за да си запази час, губиш контрол върху изживяването и често губиш и конверсии.",
    compareGoodLabel: "НАЧИНЪТ НА ALTER NINE",
    compareGoodFlow: ["Сайт", "После", "Записването е готово"],
    compareGoodText:
      "Всичко се случва във твоя сайт. Клиентите остават в твоя бранд, на твоя домейн и в изживяване за записване, създадено специално за твоя бизнес.",
    compareGoodChips: ["Без пренасочване", "Без външни платформи", "Без излишни стъпки"],
    storyEyebrow: "КАК ЗАПОЧНА ВСИЧКО",
    storyTitle: "Никога не съм очаквала,",
    storyAccent: "че ще стигна дотук",
    storyParagraphs: [
      "Никога не съм очаквала, че управлението на салон за красота ще ме отведе до разработването на софтуер.",
      "Но се случи.",
      "Докато управлявах салона си, се увлякох по програмирането. Това, което започна като любопитство, се превърна в късни нощи, в които изграждах уебсайтове, експериментирах с код и в крайна сметка създадох собствен софтуер за резервации.",
      "Осъзнах, че бизнесите не трябва да избират между красив уебсайт и система за резервации, която наистина работи.",
      "Ето защо стартирах Alter Nine.",
      "Изграждам уебсайтове за бизнеси в сферата на услугите, които са не само красиви, но и наистина полезни - от онлайн резервации и автоматизация до изживяване, на което клиентите ти действително се наслаждават."
    ],
    founderQuote:
      "По-доброто записване изглежда като малък детайл, но променя колко професионално изглежда целият ти бизнес онлайн.",
    storyCta: "Нека поговорим",
    missionEyebrow: "МИСИЯТА",
    missionTitle: "Резервациите ти не трябва да живеят в чужда",
    missionAccent: "платформа.",
    missionTitleEnd: "",
    missionSubtitle: "Нито отзивите ти.",
    missionText:
      "Много бизнеси с услуги като фризьорски салони, студиа за маникюр, козметични студиа, барбър шопове, тату студиа и масажни студиа разчитат на външни платформи за записване. Това решава част от проблема с онлайн записването, но изпраща клиентите в среда, в която твоят бизнес стои редом до конкуренти, а брандът ти остава на заден план.\n\nРезервацията се случва, но усещането, че клиентът е избрал точно теб, отслабва.\n\nAlter Nine съществува, за да промени това. Създавам уебсайтове по поръчка с изцяло вградена система за онлайн записване, така че клиентите ти да запазват часове, да плащат депозити и да получават потвърждения директно през твоя сайт.\n\nБез чужд бранд между теб и клиента. Без излишни посредници.\n\nВсичко остава **на твоя домейн, под твоя бранд** и в изживяване, създадено специално за твоя бизнес.",
    independenceEyebrow: "ЗАЩО ДА РАБОТИШ С МЕН?",
    independenceTitle: "Сайт, който остава под твой контрол.",
    independenceBody: [
      "Най-голямото предимство на сайтовете, които изграждам, е че няма да ти се налага да плащаш за всяка дребна корекция.",
      "Винаги съм държала на независимостта в собствения си бизнес и точно затова искам да дам същото и на клиентите си.",
      "Създадох контролен панел, през който можеш сам да редактираш цени, заглавия, текстове, услуги, както и да качваш и триеш снимки, без да зависиш от програмист за всяка малка промяна.",
      "Интегрирах и изкуствен интелект, който може да прочете ценоразписа ти за секунда и автоматично да въведе услугите в сайта, без да се налага да ги добавяш ръчно.",
      "Всеки записан клиент влиза в клиентската база на сайта ти, където можеш да виждаш посещенията, историята на записванията и похарчените суми."
    ],
    ...
    portfolioProjects: [
      {
        ...
        posterTheme: "urban",
        description: {
          lead: "Двуезичен уебсайт с вградена система за онлайн записване, създаден да представи услугите и портфолиото на бизнеса. Можеш да изпробваш в него процеса на записване на час.",
        },
      ...
      },
      {
        ...
        posterTheme: "kozr",
        description: {
          lead: "За тази клиентка, авто детайлингът е неосновната й дейност, затова стандартната система за записване не отговаряше на начина ѝ на работа.",
          body: [
            "Затова ѝ създадох личен Telegram бот. Услугите, цените, снимките и дори текстовете на сайта се управляват директно през чата в Telegram.",
            "Тя обновява сайта си с лекота, направо от телефона си. Всяка нова заявка пристига като съобщение в Telegram, а отговорът отнема секунди.",
          ],
          kicker: "Без админ панел, без сложно обучение, просто чат и съдържанието се променя постоянно.",
        },
        ctaLabel: "Виж на живо",
        href: "https://kozrlab.com",
        video: `${R2}/kozrlab-preview.mp4`,
    ...
    featuresTitle: "Сайт, който работи",
    featuresAccent: "за бизнеса ти.",
    featuresSubtitle: "Не просто показва услугите ти, а приема записвания, събира депозити и спестява време всеки ден.",
    features: [
      ["Сайт по поръчка", "Създаден специално за твоя бизнес, твоите услуги и начина, по който работиш."],
      ["Вградена система за записване", "Записвания, депозити и потвърждения директно през твоя сайт."],
      ["Бизнес панел", "Управлявай услуги, график и наличност лесно и на едно място."],
      ["AI инструменти", "Ускорявай ежедневната работа с помощ при ценоразписи, съдържание и клиентски запитвания."],
      ["Умна автоматизация", "Напомняния, потвърждения и покани за отзиви без ръчна работа."],
      ["Твоят бранд. Твоите данни.", "Клиентите остават в твоя сайт, а информацията остава под твой контрол."]
    ],
    ...
    reasons: [
      "Записването става директно в твоя сайт",
      "По-гладко клиентско изживяване",
      "Без зависимост от външни страници за записване",
      "По-силен и по-професионален бранд",
      "Изградено специално за твоя бизнес",
      "Бърз процес и ясна комуникация",
      "Създадено за дългосрочен растеж"
    ],
    pillarsEyebrow: "",
    pillarsTitle: "Всъщност... това е портфолиото.",
    pillarsSubtitle: "Ако вече усещаш разликата, представи си твоя сайт - с твоите цветове, твоето лого и твоя домейн.",
    pillarsCta: "Нека поговорим",
    pillarsItems: [
      ["01", "Изработен специално за твоя бизнес"],
      ["02", "Премиум визия и бързо зареждане"],
      ["03", "Сайт, създаден да превръща интереса в записвания"],
      ["04", "Работиш директно с човека, който го създава"]
    ],
    speedEyebrow: "САЙТОВЕ, СЪЗДАДЕНИ ЗА 2026 ГОДИНА",
    speedTitle: "Без WordPress. Само скорост.",
    speedChecks: [
      "Модерни технологии",
      "Оптимизиран за Google",
      "Създаден първо за мобилни устройства",
      "Достъпен",
      "Без поддръжка"
    ],
    speedBody: [
      "2026 е и няма причина сайтът ти все още да работи с 20-годишен PHP CMS и десетки плъгини, които си пречат помежду си.",
      "Изграждам върху модерни технологии, харесвани от Google - Next.js, Vite, React и edge инфраструктура, така че сайтът ти да зарежда бързо, да се класира по-добре в Google и да се усеща светкавично на всяко устройство. Най-вече на мобилни устройства, защото днес голяма част от трафика идва от телефон.",
      "Държа изключително много на резултатите в Google Lighthouse. Всеки сайт, който пускам, се измерва за Performance, Accessibility, Best Practices и SEO и не спирам, докато тези оценки не светнат в зелено."
    ],
    ...
    buildItems: [
      ...
      ["03", "Платформи по поръчка", "Уеб приложения, изградени специално за твоя бизнес. Флагманът е моят собствен софтуер за записване - същият, който стои зад всеки сайт на Alter Nine с онлайн записвания."],
      ["04", "Редизайн на сайт", "Обновяване на остарял сайт с по-бърз, по-чист и насочен към конверсия рестарт - върху модерни технологии."],
      ["05", "Портали за членове", "Зони само за членове - класове, абонаменти, заключено съдържание и връщащи се клиенти."],
    ...
    steps: [
      ...
      ["02", "Изграждам го.", "Проектирам и изграждам сайта ти от нулата, след което вграждам системата за записване директно в него. Виждаш напредъка и участваш в решенията."],
    ...
    demoTitle: "Виж как работи системата за записване",
    demoText:
      "Не е нужна регистрация. Натисни по-долу, за да пробваш реален процес на записване и да видиш точно какво ще виждат твоите клиенти.",
    demoPoints: ["Записването остава на твоя домейн", "Без пренасочване", "Без външни акаунти", "Мигновени имейл потвърждения"],
    demoPrimary: "Пробвай системата",
    demoSecondary: "Запази безплатно обаждане",
    pricingEyebrow: "ЦЕНИ",
    pricingTitle: "Всеки проект е различен. И цената му също.",
    pricingBody: [
      "Не работя с готови пакети, защото всеки бизнес има различни нужди, цели и функционалности.",
      "Започваме с разговор, уточняваме какво ти трябва и получаваш ясна оферта с точна цена преди старта."
    ],
    pricingCta: "Нека поговорим",
    faqEyebrow: "ЧЕСТО ЗАДАВАНИ ВЪПРОСИ",
    faqTitle: "Всичко, което клиентите обикновено питат преди да започнем",
    ...
    faqs: [
      ...
      ["Чий е сайтът след пускането?", "Домейнът, съдържанието и самият сайт остават твои - винаги. Единственото изключение е вградената система за записване: тя работи върху моята инфраструктура, така че ако някога приключим работа, тази част спира да работи. За лендинг страници или обикновени сайтове без система за записване всичко е изцяло твое, без условности."],
      ...
      ["Трябва ли ми Calendly или друга платформа за записване?", "Не. Системата за записване е интегрирана директно в твоя сайт."],
      ...
      ["Ще работи ли сайтът на телефон и iPad?", "Абсолютно. Всеки сайт е създаден първо за мобилни устройства и се тества на телефони, таблети и десктоп преди пускане. Ще изглежда и ще работи както трябва, независимо дали клиентът ти е на Android, iPhone или iPad."],
      ["Какво ако бизнесът ми порасне - мога ли да добавя още услуги или локации?", "Да. Услугите ги управляваш сам - просто снимаш и AI попълва детайлите. За по-големи промени като допълнителни локации, още езици, календари за служители или цели нови секции, ги добавям, когато ти потрябват. Няма да надраснеш сайта и няма да се налага да започваш от нулата."],
      ["Може ли да преработите сегашния ми сайт?", "Да. Можем да подобрим сегашния ти сайт или да създадем изцяло нов."],
      ["Кой прави сайта?", "Всеки проект се проектира и изгражда директно от основателя, за да има последователен процес и лично отношение."],
      ["Какво става след пускането?", "След пускането оставам насреща, за да съм сигурна, че всичко работи гладко. Ако ти трябват подобрения, промени или нови функции с растежа на бизнеса ти, можем да ги обсъдим."]
    ],
    ctaEyebrow: "ГОТОВ ЛИ СИ БИЗНЕСЪТ ТИ ДА ИМА САЙТ, КОЙТО РАБОТИ ЗА НЕГО?",
    ctaTitle: "Дай на бизнеса си сайт, който води клиентите",
    ctaAccent: "до потвърден час",
    ctaText: "Запази безплатна консултация и нека поговорим за твоя проект.",
    footerText: "Уебсайтове по поръчка с вградена система за онлайн записване",
    footerLegal: [
    ...
    demoSubject: "Демо на система за записване",
    jsonLd: {
      "@context": "https://schema.org",
      "@graph": [
        {
        ...
        {
          "@type": "FAQPage",
          "@id": "https://alternine.co/bg#faq",
          mainEntity: [
            {
              "@type": "Question",
              name: "Колко време отнема проектът?",
              acceptedAnswer: {
                "@type": "Answer",
                text: "Повечето проекти се завършват за 1 до 2 седмици според сложността и нужните материали."
              }
            },
            {
              "@type": "Question",
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "Домейнът, съдържанието и самият сайт остават твои - винаги. Единственото изключение е вградената система за записване: тя работи върху моята инфраструктура, така че ако някога приключим работа, тази част спира да работи. За лендинг страници или обикновени сайтове без система за записване всичко е изцяло твое, без условности."
              }
            },
            {
              "@type": "Question",
            ...
            {
              "@type": "Question",
              name: "Могат ли клиентите да плащат онлайн?",
              acceptedAnswer: {
                "@type": "Answer",
                text: "Да. Stripe е напълно интегриран, така че клиентите могат да платят депозит или цялата сума директно при записването. Възстановяванията и разписките също минават през Stripe."
              }
            },
            {
              "@type": "Question",
              name: "Трябва ли ми Calendly или друга платформа за записване?",
              acceptedAnswer: {
                "@type": "Answer",
                text: "Не. Системата за записване е интегрирана директно в твоя сайт."
              }
            },
            {
              "@type": "Question",
              name: "Ами домейнът? Трябва ли вече да имам?",
              acceptedAnswer: {
                "@type": "Answer",
                text: "Ако вече имаш домейн, го свързвам с новия сайт без допълнително заплащане. Ако нямаш, го купувам на твое име и го настройвам - ти оставаш собственик от първия ден."
              }
            },
            {
              "@type": "Question",
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "Абсолютно. Всеки сайт е създаден първо за мобилни устройства и се тества на телефони, таблети и десктоп преди пускане. Ще изглежда и ще работи както трябва, независимо дали клиентът ти е на Android, iPhone или iPad."
              }
            },
            {
              "@type": "Question",
              name: "Какво ако бизнесът ми порасне - мога ли да добавя още услуги или локации?",
              acceptedAnswer: {
                "@type": "Answer",
                text: "Да. Услугите ги управляваш сам - просто снимаш и AI попълва детайлите. За по-големи промени като допълнителни локации, още езици, календари за служители или цели нови секции, ги добавям, когато ти потрябват. Няма да надраснеш сайта и няма да се налага да започваш от нулата."
              }
            },
            {
              "@type": "Question",
              name: "Може ли да преработите сегашния ми сайт?",
              acceptedAnswer: {
                "@type": "Answer",
                text: "Да. Можем да подобрим сегашния ти сайт или да създадем изцяло нов."
              }
            },
            {
              "@type": "Question",
              name: "Кой прави сайта?",
              acceptedAnswer: {
                "@type": "Answer",
                text: "Всеки проект се проектира и изгражда директно от основателя, за да има последователен процес и лично отношение."
              }
            },
            {
              "@type": "Question",
              name: "Какво става след пускането?",
              acceptedAnswer: {
                "@type": "Answer",
                text: "След пускането оставам насреща, за да съм сигурна, че всичко работи гладко. Ако ти трябват подобрения, промени или нови функции с растежа на бизнеса ти, можем да ги обсъдим."
              }
            }
          ]
        },
